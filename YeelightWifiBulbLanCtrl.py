...
def set_full_fire(idx):
  operate_on_bulb(idx,"set_scene","\"ct\",3200,100")
#   {"id":4,"method":"set_scene","params":["ct",3200,100]}
  
def set_mid(idx):
  operate_on_bulb(idx,"set_scene","\"color\","+str((255*65536)+(96*256)+0)+",100")
#   {"id":2,"method":"set_scene","params":["color",16736256,100]}
  
def set_low(idx):
  operate_on_bulb(idx,"set_scene","\"color\","+str((255*65536)+(58*256)+0)+",1")
#   {"id":3,"method":"set_scene","params":["color",16726528,1]}

def set_shut(idx):
  operate_on_bulb(idx, "set_power", "\"off\"")
...
def print_cli_usage():
  ...
  print "  f|full <idx>: set scene \"full fire\" to bulb indicated by idx"
  print "  m|mid <idx>: set scene \"mid\" to bulb indicated by idx"
  print "  lw|low <idx>: set scene \"low\" to bulb indicated by idx"
  print "  s|shut <idx>: shut off bulb indicated by idx"
